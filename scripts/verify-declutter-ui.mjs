...
assert(roleNav.match(/AUDITOR_NAV[\s\S]*?id: "sync", label: "Sync Centre"/), "auditor primary nav includes Sync Centre");
assert(permissions.includes('if (itemId === "sync")') && permissions.includes('role === "Auditor"'), "sync centre available to auditors via nav");
