 ...
 * Examination recording lives in loler-examination-service.mjs (re-exported below).
 */
import {
  LOLER_EQUIPMENT_TAB,
 ...
 * Narrowly exported for loler-examination-service.mjs only.
 */
export async function syncOpenLolerSchedule(auth, deps, masterSheetId, equipment, actor, options = {}) {
...
/** Temporary re-exports — examination APIs live in loler-examination-service.mjs. */
export {
