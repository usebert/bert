...
import { computePromptPackFingerprint as buildPromptFingerprint } from "./midlands-evidence-scene-resolver.mjs";
export const EVIDENCE_SCENE_CATALOG = [
  ...
  {
    key: "rugby-estop-cover",
    site: "rugby",
    category: "rugby",
    subject: "cracked emergency stop cover on aggregate conveyor",
    location: "Rugby batching plant aggregate conveyor line",
    viewpoint: "close mobile photo of emergency stop button housing on conveyor",
    lighting: "industrial daylight",
    defect: "cracked yellow E-stop cover plate with exposed switch edges",
  },
  {
    key: "rugby-emergency-route-blocked",
    site: "rugby",
    category: "rugby",
    subject: "emergency access route blocked by pallets",
    location: "Rugby batching bay emergency route",
    viewpoint: "mobile photo along marked emergency walkway",
    lighting: "yard daylight",
    defect: "wooden pallets obstructing green-striped emergency route",
  },
  {
    key: "rugby-silo-ladder-tag-missing",
    site: "rugby",
    category: "rugby",
    subject: "cement silo ladder with missing inspection tag",
    location: "Rugby batching plant secondary silo",
    viewpoint: "looking up at silo ladder cage and tag holder",
    lighting: "overcast industrial daylight",
    defect: "empty tag holder on silo ladder access point",
  },
  {
    key: "rugby-damaged-110v-lead",
    site: "rugby",
    category: "rugby",
    subject: "damaged 110V electrical lead on precast bay",
    location: "Rugby precast production bay",
    viewpoint: "close mobile photo of trailing lead across concrete floor",
    lighting: "workshop fluorescent",
    defect: "frayed insulation on yellow 110V extension lead near formwork",
  },
  {
    key: "rugby-cement-dust-silo",
    site: "rugby",
    category: "rugby",
    subject: "cement dust accumulation on silo ledges",
    location: "Rugby batching plant silo base and access platform",
    viewpoint: "mobile photo of dust-coated ledges and handrail near silo",
    lighting: "overcast daylight with visible dust",
    defect: "thick grey cement dust on silo ledges and platform plates",
  },
  {
    key: "rugby-cement-dust-silo-cleaned",
    site: "rugby",
    category: "rugby",
    variant: "after",
    subject: "cleaned silo ledges after housekeeping",
    location: "Rugby batching plant silo base and access platform",
    viewpoint: "same angle on silo ledges after cleaning",
    lighting: "overcast daylight",
    defect: "corrected condition with dust removed from ledges and handrail",
  },
  {
    key: "rugby-mould-oil-no-containment",
    site: "rugby",
    category: "rugby",
    subject: "mould oil drums without secondary containment",
    location: "Rugby precast workshop oil storage area",
    viewpoint: "bench-height photo of oil drums on bare concrete",
    lighting: "workshop fluorescent",
    defect: "mould oil drums with no bund or drip tray beneath",
  },
  {
    key: "rugby-washout-sump-blocked",
    site: "rugby",
    category: "rugby",
    subject: "blocked concrete washout sump",
    location: "Rugby batching plant washout bay",
    viewpoint: "low mobile photo of washout sump grate and surrounding slurry",
    lighting: "damp overcast light",
    defect: "sump grate partially blocked by dried concrete and debris",
  },
  {
    key: "rugby-washout-overflow",
    site: "rugby",
    category: "rugby",
    subject: "washout area overflow and poor environmental control",
    location: "Rugby batching plant washout bund",
    viewpoint: "mobile photo of overflowing washout channel",
    lighting: "damp overcast",
    defect: "washout effluent pooling outside bund edging",
  },
  {
    key: "rugby-admixture-leak",
    site: "rugby",
    category: "rugby",
    subject: "admixture drum leak at coupling",
    location: "Rugby batching plant admixture storage",
    viewpoint: "close photo of drum valve and coupling",
    lighting: "industrial daylight",
    defect: "minor chemical leak staining concrete below admixture drum",
  },
  {
    key: "rugby-admixture-contained",
    site: "rugby",
    category: "rugby",
    variant: "after",
    subject: "contained admixture leak after correction",
    location: "Rugby batching plant admixture storage",
    viewpoint: "same coupling angle after containment",
    lighting: "industrial daylight",
    defect: "corrected condition with drip tray and absorbent pads in place",
  },
  {
    key: "rugby-lab-sample-console",
    site: "rugby",
    category: "rugby",
    subject: "concrete lab sample left on batching console",
    location: "Rugby batching plant control cabin",
    viewpoint: "mobile photo of batching control desk",
    lighting: "screen glare and cabin light",
    defect: "fresh concrete sample cup left on control console beside switches",
  },
  {
    key: "rugby-silo-fill-dust",
    site: "rugby",
    category: "rugby",
    subject: "dust cloud during cement silo filling",
    location: "Rugby batching plant silo fill point",
    viewpoint: "mobile photo toward silo fill pipe with dust plume",
    lighting: "backlit dust in overcast daylight",
    defect: "visible dust escape during pneumatic silo fill",
  },
  {
    key: "rugby-loader-pedestrian-near-miss",
    site: "rugby",
    category: "rugby",
    subject: "front loader reversing near pedestrian walkway",
    location: "Rugby aggregate yard pedestrian crossing",
    viewpoint: "mobile photo across yard showing loader and walkway",
    lighting: "yard daylight",
    defect: "loader reversing toward marked pedestrian crossing without clear sight line",
  },
  {
    key: "rugby-grout-trip-hazard",
    site: "rugby",
    category: "rugby",
    subject: "leftover grout on mixer platform creating trip hazard",
    location: "Rugby batching plant mixer platform",
    viewpoint: "mobile photo of platform floor at foot level",
    lighting: "industrial daylight",
    defect: "hardened grout patches and debris on walkway surface",
  },
  {
    key: "rugby-grout-cleared",
    site: "rugby",
    category: "rugby",
    variant: "after",
    subject: "cleared mixer platform after housekeeping",
    location: "Rugby batching plant mixer platform",
    viewpoint: "same platform angle after cleaning",
    lighting: "industrial daylight",
    defect: "corrected condition with grout removed and clear walkway",
  },
  {
    key: "coventry-wheel-chocks-missing",
    site: "coventry",
    category: "coventry",
    subject: "articulated trailer without wheel chocks",
    location: "Coventry dispatch yard loading bay",
    viewpoint: "low mobile photo of trailer wheels on apron",
    lighting: "overcast yard light",
    defect: "waiting artic trailer with no chocks at rear wheels",
  },
  {
    key: "coventry-trailer-no-banksman",
    site: "coventry",
    category: "coventry",
    subject: "trailer loading without banksman present",
    location: "Coventry dispatch loading bay",
    viewpoint: "mobile photo of trailer being loaded from bay edge",
    lighting: "yard daylight",
    defect: "forklift loading trailer with no banksman visible at cab line",
  },
  {
    key: "coventry-crane-slew-walkway",
    site: "coventry",
    category: "coventry",
    subject: "overhead crane slew path over pedestrian walkway",
    location: "Coventry precast lifting bay",
    viewpoint: "upward-angled photo showing crane hook over walkway",
    lighting: "industrial bay light",
    defect: "crane hook positioned above marked pedestrian route",
  },
  {
    key: "coventry-lifting-tag-missing-dispatch",
    site: "coventry",
    category: "coventry",
    subject: "lifting accessory with missing dispatch inspection tag",
    location: "Coventry dispatch lifting gear point",
    viewpoint: "close photo of shackle and empty tag holder",
    lighting: "yard daylight",
    defect: "missing colour-coded LOLER tag on lifting accessory ready for dispatch",
  },
  {
    key: "coventry-route-marking-corrected",
    site: "coventry",
    category: "coventry",
    variant: "after",
    subject: "repainted pedestrian barriers and refreshed route markings",
    location: "Coventry dispatch yard pedestrian route",
    viewpoint: "mobile photo along refreshed walkway markings",
    lighting: "overcast yard light",
    defect: "corrected condition with repainted barriers and visible route lines",
  },
  {
    key: "quality-finished-repair",
    site: "coventry",
    category: "quality",
    variant: "after",
    subject: "repaired precast unit edge after remedial work",
    location: "Coventry finishing bay",
    viewpoint: "close photo of repaired arris on cured unit",
    lighting: "indoor inspection bay light",
    defect: "corrected condition with filled edge spall and fair finish",
  },
  {
    key: "quality-repair-documentation",
    site: "coventry",
    category: "quality",
    subject: "incomplete remedial repair documentation folder",
    location: "Coventry quality office adjacent to finishing bay",
    viewpoint: "mobile photo of open repair record folder on bench",
    lighting: "office fluorescent",
    defect: "repair record missing sign-off sheet and photos",
  },
];
...
export const BEFORE_AFTER_PAIR_DEFINITIONS = [
  ...
  },
  {
    pairId: "pair-washout",
    recordType: "action",
    beforeScene: "rugby-washout-sump-blocked",
    afterScene: "rugby-washout-cleaned",
    matchNote: /washout|housekeeping|clean|sump/i,
  },
  {
...
export function buildPromptPack(plan) {
  ...
  pack.fingerprint = crypto
    .createHash("sha256")
    .update(JSON.stringify(buildPromptFingerprint(pack)))
    .digest("hex");
  return pack;
}
