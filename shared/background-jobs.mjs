...
export const BACKGROUND_JOB_TYPES = {
  ...
  REBUILD_AUTH_INDEX: "REBUILD_AUTH_INDEX",
  VERIFY_AUTH_INDEX: "VERIFY_AUTH_INDEX",
  SYNC_PENDING_COMPLETION: "SYNC_PENDING_COMPLETION",
};
...
export const BACKGROUND_JOB_STATUS_BADGES = {
  ...
  REBUILD_AUTH_INDEX: "Finishing updates",
  VERIFY_AUTH_INDEX: "Finishing updates",
  SYNC_PENDING_COMPLETION: "Syncing check result",
