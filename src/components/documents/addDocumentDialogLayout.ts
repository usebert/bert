...
export type AddDocumentDialogLayoutSnapshot = {
  viewportWidth: number;
  viewportHeight: number;
  dialog: LayoutRect;
  header: LayoutRect;
  footer: LayoutRect;
  firstField: LayoutRect;
  bodyScrollHeight: number;
  bodyClientHeight: number;
};

export type AddDocumentDialogLayoutResult = {
  ok: boolean;
  failures: string[];
};

export function rectFromValues(top: number, left: number, width: number, height: number): LayoutRect {
  return {
    top,
    left,
    width,
...
function overlapsViewport(rect: LayoutRect, viewportHeight: number, viewportWidth: number) {
  return (
...
export function evaluateAddDocumentDialogViewportLayout(
  snapshot: AddDocumentDialogLayoutSnapshot,
): AddDocumentDialogLayoutResult {
