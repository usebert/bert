...
const GROUPS_BY_BUCKET: Record<ReturnType<typeof getRoleNavBucket>, NavPresentationGroup[]> = {
  ...
  companyAdmin: [
    ...
    { id: "work", label: "Work", itemIds: ["auditCentre", "actions", "schedules", "briefings", "results"] },
    {
      id: "compliance",
      label: "Compliance",
      itemIds: ["documents", "documentControl", "incidents", "nonConformance", "loler", "reports", "calendar"],
    },
    {
      id: "administration",
      label: "Administration",
      itemIds: ["users", "sync", "archive", "account"],
    },
  ],
  manager: [
    { id: "home", label: "Home", itemIds: ["dashboard"] },
  ...
  auditor: [
    { id: "home", label: "Home", itemIds: ["dashboard"] },
    { id: "work", label: "Work", itemIds: ["auditCentre", "briefings"] },
    {
      id: "compliance",
      label: "Compliance",
