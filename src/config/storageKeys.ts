...
export const storageKeys = {
  ...
  /** Active company members — keyed by company folder id in JSON payload. */
  ...
  /** App-level SWR cache — keyed by logical cache key in JSON payload. */
  appDataCache: "bert-app-data-cache",
} as const;
